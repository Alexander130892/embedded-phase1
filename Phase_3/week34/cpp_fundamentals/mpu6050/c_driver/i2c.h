 ...
 *
 * Description:
 *   This header file defines the I2C driver interface for the
 *   STM32F446RE microcontroller, providing functions to initialize I2C
 *   communication, perform read/write operations on bytes and
 *   registers, and handle bus recovery. It includes configuration
 *   macros for I2C frequency settings (100KHz) and GPIO
 *   initialization.
 */
#ifndef I2C_H_
#define I2C_H_
