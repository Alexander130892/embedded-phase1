 ...
 *
 * Description:
 *   This file implements ARM Cortex-M4F port-specific functionality
 *   for FreeRTOS, providing hardware abstraction for context
 *   switching, interrupt handling, and floating-point support on ARM
