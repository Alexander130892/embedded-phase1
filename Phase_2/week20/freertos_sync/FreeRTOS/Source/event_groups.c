 ...
 *
 * Description:
 *   This file implements FreeRTOS event groups, which allow tasks to
 *   synchronize by waiting for and setting specific bits in an event
 *   group. The implementation provides APIs for creating, deleting,
 *   and manipulating event groups while handling both static and
 *   dynamic memory allocation modes.
 */
/* Standard includes. */
#include <stdlib.h>
