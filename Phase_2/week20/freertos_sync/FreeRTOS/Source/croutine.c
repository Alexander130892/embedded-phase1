 ...
 *
 * Description:
 *   This file implements the core scheduler and management functions
 *   for FreeRTOS co-routines, a lightweight threading alternative that
 *   uses a cooperative multitasking model with ready queues organized
 *   by priority and delayed co-routine tracking lists.
 */
#include "FreeRTOS.h"
#include "task.h"
#include "croutine.h"
