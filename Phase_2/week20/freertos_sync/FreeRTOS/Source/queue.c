 ...
 *   mutexes in a real-time operating system kernel. It defines queue
 *   structures, synchronization primitives, and handles task
 *   blocking/unblocking for inter-task communication.
 */
#include <stdlib.h>
#include <string.h>
