 ...
 *   providing functionality for creating, scheduling, and managing
 *   tasks in both single-core and multi-core environments. It includes
 *   task lifecycle management, priority-based scheduling with
 *   preemption support, and task notification mechanisms.
 */
/* Standard includes. */
#include <stdlib.h>
#include <string.h>
