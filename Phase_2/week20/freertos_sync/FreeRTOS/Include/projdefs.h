 ...
 *
 * Description:
 *   This file defines fundamental FreeRTOS data types, macros, and
 *   error codes, including the task function prototype, time
 *   conversion utilities between milliseconds and ticks,
 *   boolean/status constants, and POSIX-like errno values for
 *   FreeRTOS+ components.
 */
#ifndef PROJDEFS_H
#define PROJDEFS_H
