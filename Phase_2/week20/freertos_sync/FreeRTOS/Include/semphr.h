 ...
 *
 * Description:
 *   This file defines the semaphore API for FreeRTOS, implementing
 *   semaphores as wrappers around the existing queue mechanism with
 *   macros and function declarations for creating and managing binary
 *   semaphores, mutexes, and counting semaphores. It requires
 *   FreeRTOS.h to be included first and provides both deprecated
 *   macro-based and modern function-based interfaces for semaphore
 *   creation.
 */
#ifndef SEMAPHORE_H
#define SEMAPHORE_H
