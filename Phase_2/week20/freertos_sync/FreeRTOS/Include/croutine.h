 ...
 *   for FreeRTOS co-routines, which are lightweight pseudo-threads
 *   that provide a way to implement concurrent tasks with minimal
 *   memory overhead by using macros to manage state and context
 *   switching.
 */
#ifndef CO_ROUTINE_H
#define CO_ROUTINE_H
