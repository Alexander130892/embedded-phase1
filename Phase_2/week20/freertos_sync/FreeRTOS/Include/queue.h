 ...
 *
 * Description:
 *   This is the FreeRTOS queue header file that defines the API and
 *   type definitions for creating and managing queues, semaphores, and
 *   queue sets used for inter-task communication and synchronization.
 *   It requires FreeRTOS.h to be included first and provides function
 *   declarations and macros for queue operations in embedded real-time
 *   systems.
 */
#ifndef QUEUE_H
#define QUEUE_H
