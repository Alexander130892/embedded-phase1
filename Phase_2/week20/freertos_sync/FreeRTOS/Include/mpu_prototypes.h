 ...
 *
 * Description:
 *   This header file defines MPU-protected wrapper function prototypes
 *   that allow standard FreeRTOS API calls to be redirected through
 *   privilege-promoting wrappers, enabling kernel operations to
 *   execute with elevated privileges while user application code
 *   remains unprivileged. It includes struct definitions for parameter
 *   passing and declares MPU-prefixed versions of various kernel API
 *   functions marked as system calls.
 */
/*
