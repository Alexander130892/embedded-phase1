 ...
 *
 * Description:
 *   This file is the FreeRTOS task management header that defines the
 *   core task-related types, macros, and function prototypes for
 *   creating and managing concurrent tasks in an RTOS environment. It
 *   requires FreeRTOS.h to be included first and provides task
 *   handles, state enumerations, notification actions, and MPU region
 *   configuration constants for the v11.1.0+ kernel version.
 */
#ifndef INC_TASK_H
#define INC_TASK_H
