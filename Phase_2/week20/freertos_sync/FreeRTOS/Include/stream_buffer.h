 ...
 *   lightweight inter-task communication mechanism designed for
 *   continuous data streaming between a single writer and single
 *   reader (which may be tasks or interrupts). Stream buffers use
 *   dynamically or statically allocated memory and support
 *   configurable trigger levels to unblock waiting readers when
