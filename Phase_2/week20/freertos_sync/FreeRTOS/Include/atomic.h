 ...
 *
 * Description:
 *   This file provides FreeRTOS atomic operation primitives
 *   (compare-and-swap, swap, add, etc.) implemented by disabling
 *   interrupts globally, with support for both nested and non-nested
 *   interrupt architectures. It defines critical section macros and
 *   atomic helper functions that ensure thread-safe access to shared
 *   variables across FreeRTOS tasks and compatible ISRs.
 */
/**
 * @file atomic.h
