 ...
 *   including timer command codes, type definitions (TimerHandle_t,
 *   callback function prototypes), and the interface for creating and
 *   managing software timers. It requires FreeRTOS.h to be included
 *   first and provides both task-context and interrupt-safe timer
 *   operations.
 */
#ifndef TIMERS_H
#define TIMERS_H
