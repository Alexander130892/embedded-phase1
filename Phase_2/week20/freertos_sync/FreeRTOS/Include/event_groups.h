 ...
 *
 * Description:
 *   This file defines the public API and type definitions for FreeRTOS
 *   event groups, which are synchronization primitives that allow
 *   tasks to wait for and signal specific bit patterns to coordinate
 *   behavior. It includes configuration macros for control bits and
 *   type definitions for event group handles and event bits.
 */
