 ...
 *   communication, including register read/write operations, DMA-based
 *   burst reads, compensation parameter retrieval, and the
 *   Bosch-specified integer compensation formulas to convert raw ADC
 *   values into calibrated temperature and pressure readings. The
 *   entire implementation is commented out, suggesting it is either
 *   work-in-progress, replaced by another version, or temporarily
 *   disabled.
 */
///*
// * bmp280.c
...
//
////SPI
//static uint8_t bmp280_read_register(uint8_t addr){
//	uint8_t data;
//	// Set CS low
...
//}
//static void bmp280_read_burst(uint8_t addr, uint32_t n_data, uint8_t* memory_addr){
//	spi_dma_read(addr, n_data, memory_addr);
//	while(dma_s0_flag == 0){};
//	dma_s0_flag = 0;
//}
//static void bmp280_comp_params(comp_param_t *cp){
...
//	i2c_read_register(0x76, 0xD0, data);
//}
//static void bmp280_i2c_comp_params(comp_param_t *cp){
//	cp->dig_T1 = (bmp280_i2c_read_register(0x89)<<8 | bmp280_i2c_read_register(0x88) );
//	cp->dig_T2 = (bmp280_i2c_read_register(0x8B)<<8 | bmp280_i2c_read_register(0x8A) );
//	cp->dig_T3 = (bmp280_i2c_read_register(0x8D)<<8 | bmp280_i2c_read_register(0x8C) );
//	cp->dig_P1 = (bmp280_i2c_read_register(0x8F)<<8 | bmp280_i2c_read_register(0x8E) );
//	cp->dig_P2 = (bmp280_i2c_read_register(0x91)<<8 | bmp280_i2c_read_register(0x90) );
//	cp->dig_P3 = (bmp280_i2c_read_register(0x93)<<8 | bmp280_i2c_read_register(0x92) );
//	cp->dig_P4 = (bmp280_i2c_read_register(0x95)<<8 | bmp280_i2c_read_register(0x94) );
//	cp->dig_P5 = (bmp280_i2c_read_register(0x97)<<8 | bmp280_i2c_read_register(0x96) );
//	cp->dig_P6 = (bmp280_i2c_read_register(0x99)<<8 | bmp280_i2c_read_register(0x98) );
//	cp->dig_P7 = (bmp280_i2c_read_register(0x9B)<<8 | bmp280_i2c_read_register(0x9A) );
//	cp->dig_P8 = (bmp280_i2c_read_register(0x9D)<<8 | bmp280_i2c_read_register(0x9C) );
//	cp->dig_P9 = (bmp280_i2c_read_register(0x9F)<<8 | bmp280_i2c_read_register(0x9E) );
//}
