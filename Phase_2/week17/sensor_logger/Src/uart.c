 ...
 *   microcontroller using USART2 (115200 baud, pins PA2/PA3),
 *   providing initialisation, polled character/string transmission,
 *   and interrupt-driven reception into a circular buffer. Received
 *   bytes are stored via the USART2 IRQ handler and consumed by
 *   `uart_receive_string`, which assembles complete lines delimited by
