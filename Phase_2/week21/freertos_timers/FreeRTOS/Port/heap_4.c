 ...
 *
 * Description:
 *   This file implements a FreeRTOS heap memory allocator (heap_4)
 *   that provides dynamic memory allocation with automatic coalescing
 *   of adjacent free blocks to reduce fragmentation. It tracks
 *   allocated and free memory blocks using a linked list structure and
 *   includes optional heap corruption detection via canary values.
 */
/*
