 ...
 *   Cortex-M4F processors, defining hardware register mappings,
 *   interrupt priorities, and constants needed to manage the
 *   processor's core, SysTick timer, and floating-point unit.
 */
/*-----------------------------------------------------------
