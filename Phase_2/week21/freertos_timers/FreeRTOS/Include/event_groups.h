 ...
 *
 * Description:
 *   This is a FreeRTOS header file that defines the interface and
 *   types for event groups, a synchronization primitive that allows
 *   tasks to wait on and signal multiple bits to coordinate behavior.
 *   It provides macro definitions for control bits and type
 *   definitions (EventGroupHandle_t and EventBits_t) used by event
 *   group functions.
 */
