 ...
 *
 * Description:
 *   This file defines the FreeRTOS semaphore API by providing macros
 *   and type definitions that implement semaphores using the
 *   underlying queue mechanism. It serves as the header file for
 *   creating and managing binary semaphores, counting semaphores, and
 *   mutexes in FreeRTOS applications.
 */
#ifndef SEMAPHORE_H
#define SEMAPHORE_H
