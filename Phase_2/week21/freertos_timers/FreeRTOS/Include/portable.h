 ...
 *
 * Description:
 *   This file defines the portable abstraction layer API for FreeRTOS,
 *   including architecture-specific includes (portmacro.h), byte
 *   alignment configurations, and MPU wrapper support that must be
 *   implemented for each hardware port.
 */
/*-----------------------------------------------------------
