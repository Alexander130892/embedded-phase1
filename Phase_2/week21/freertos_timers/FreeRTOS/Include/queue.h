 ...
 *
 * Description:
 *   This is a FreeRTOS header file that defines the queue API and data
 *   structures for inter-task communication, providing functions and
 *   types for creating and managing queues, semaphores, and queue sets
 *   in embedded real-time systems. It requires FreeRTOS.h to be
 *   included first and defines opaque handle types for queues, queue
 *   sets, and related synchronization primitives.
 */
#ifndef QUEUE_H
#define QUEUE_H
