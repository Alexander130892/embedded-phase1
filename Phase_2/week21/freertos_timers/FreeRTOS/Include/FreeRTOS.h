 ...
 *
 * Description:
 *   This file is the main FreeRTOS kernel header that includes
 *   standard library headers, loads user configuration from
 *   FreeRTOSConfig.h, validates tick timer width settings, and
 *   includes port-specific and architecture-specific definitions. It
 *   serves as the central entry point for FreeRTOS kernel
 *   functionality with backward compatibility handling for deprecated
