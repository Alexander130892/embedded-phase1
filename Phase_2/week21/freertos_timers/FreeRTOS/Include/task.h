 ...
 *
 * Description:
 *   This is a FreeRTOS header file that defines the core task
 *   management interface, including task handle types, state
 *   enumerations, notification actions, and MPU (Memory Protection
 *   Unit) region configuration macros for embedded real-time systems.
 *   It requires FreeRTOS.h to be included first and provides the
 *   foundational types and constants for task creation, manipulation,
