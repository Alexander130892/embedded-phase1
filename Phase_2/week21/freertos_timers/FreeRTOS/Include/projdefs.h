 ...
 *
 * Description:
 *   This FreeRTOS header file defines fundamental project-wide types,
 *   macros, and constants including the TaskFunction_t prototype, time
 *   conversion macros (milliseconds to ticks), boolean/status return
 *   codes, error definitions, data integrity check values, and
 *   POSIX-compatible errno definitions for FreeRTOS+ components.
 */
#ifndef PROJDEFS_H
#define PROJDEFS_H
