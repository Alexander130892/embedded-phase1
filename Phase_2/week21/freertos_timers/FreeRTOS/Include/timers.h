 ...
 *
 * Description:
 *   This file defines the FreeRTOS software timer API, including timer
 *   handle types, callback function prototypes, command IDs for timer
 *   operations, and function declarations for creating and managing
 *   software timers. It requires FreeRTOS.h to be included first and
 *   provides a queue-based interface for timer commands that can be
 *   issued from both tasks and interrupt service routines.
 */
#ifndef TIMERS_H
#define TIMERS_H
