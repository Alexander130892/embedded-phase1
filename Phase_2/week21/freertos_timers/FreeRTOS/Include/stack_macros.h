 ...
 *
 * Description:
 *   This header file defines macros for detecting task stack overflow
 *   in FreeRTOS by checking whether the current stack pointer has
 *   exceeded safe limits, with support for both downward and upward
 *   stack growth architectures. It provides configurable detection
 *   levels: basic checks compare the stack pointer against bounds,
 *   while enhanced checks also verify that guard values haven't been
 *   overwritten.
 */
