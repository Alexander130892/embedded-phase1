 ...
 *
 * Description:
 *   This FreeRTOS header file provides atomic operation primitives by
 *   disabling interrupts globally, with implementations supporting
 *   both nested and non-nested interrupt schemes. It defines macros
 *   and inline functions (like compare-and-swap) to enable thread-safe
 *   access to shared variables across FreeRTOS tasks and interrupt
 *   service routines.
 */
/**
 * @file atomic.h
