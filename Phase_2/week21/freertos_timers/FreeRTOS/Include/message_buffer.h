 ...
 *
 * Description:
 *   This file defines the API and interface for FreeRTOS message
 *   buffers, which provide a lightweight mechanism for sending
 *   variable-length discrete messages between tasks or interrupts.
 *   Message buffers are built on top of stream buffers and require
 *   serialization if multiple writers or readers access the same
 *   buffer.
 */
/*
