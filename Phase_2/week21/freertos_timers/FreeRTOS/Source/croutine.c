 ...
 *
 * Description:
 *   This file implements the scheduler and management functions for
 *   FreeRTOS co-routines, a lightweight alternative to full tasks that
 *   share execution context and use less memory. It maintains priority
 *   queues for ready co-routines, handles delayed co-routine wake-ups,
 *   and manages state transitions between ready and blocked states.
 */
#include "FreeRTOS.h"
#include "task.h"
#include "croutine.h"
