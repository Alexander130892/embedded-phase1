 ...
 *
 * Description:
 *   This file implements FreeRTOS queue management, including queue,
 *   semaphore, and mutex operations for inter-task communication and
 *   synchronization. It defines the core queue data structures and
 *   provides mechanisms for task blocking/unblocking based on queue
 *   availability in a real-time embedded operating system.
 */
#include <stdlib.h>
#include <string.h>
