 ...
 *
 * Description:
 *   This file implements the software timer functionality for
 *   FreeRTOS, providing timer creation, management, and callback
 *   execution services that are conditionally compiled based on the
 *   `configUSE_TIMERS` configuration option. It defines the core timer
 *   control structure and supporting infrastructure for scheduling and
 *   executing timer callbacks at specified intervals.
 */
/* Standard includes. */
#include <stdlib.h>
