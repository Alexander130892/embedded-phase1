 ...
 *
 * Description:
 *   This file is the core implementation of FreeRTOS task management,
 *   handling task creation, scheduling, context switching, and task
 *   lifecycle management across single and multi-core systems. It
 *   includes conditional compilation logic for MPU support, preemption
 *   modes, and optional statistics formatting features.
 */
/* Standard includes. */
#include <stdlib.h>
#include <string.h>
