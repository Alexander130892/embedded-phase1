 ...
 *   driver defines register addresses, a packed struct for storing
 *   factory calibration (compensation) parameters read from the
 *   sensor, and declares the internal functions used to convert raw
 *   ADC readings into compensated temperature and pressure values.
 */
