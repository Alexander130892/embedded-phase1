 ...
 *
 * Description:
 *   This file is the FreeRTOS queue header that defines queue and
 *   queue set handle types, internal macros, and documents the queue
 *   creation API for inter-task communication and synchronization. It
 *   requires FreeRTOS.h to be included first and provides type-safe
 *   references to queue structures while hiding their implementation
 *   details.
 */
#ifndef QUEUE_H
#define QUEUE_H
