 ...
 *
 * Description:
 *   This file defines the portable layer API for FreeRTOS, providing
 *   architecture-specific abstractions and macros that must be
 *   implemented for each hardware port. It includes the appropriate
 *   `portmacro.h` header, sets up memory alignment masks, configures
 *   MPU and stack overflow checking options, and declares the stack
 *   initialization function signature with conditional compilation
 *   based on port capabilities.
 */
/*-----------------------------------------------------------
