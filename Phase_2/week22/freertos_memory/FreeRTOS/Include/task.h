 ...
 *
 * Description:
 *   This is a FreeRTOS header file that defines task management APIs,
 *   data types, and constants for creating and controlling tasks in a
 *   real-time operating system. It provides task handles, state
 *   definitions, notification mechanisms, and MPU region
