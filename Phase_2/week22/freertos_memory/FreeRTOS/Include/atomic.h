 ...
 *
 * Description:
 *   This file provides FreeRTOS atomic operation primitives that
 *   ensure thread-safe access to shared variables by disabling
 *   interrupts, with support for both nested and non-nested interrupt
 *   architectures. It defines macros and inline functions (such as
 *   compare-and-swap) for atomic operations that can be used in
 *   FreeRTOS tasks and, conditionally, in interrupt service routines.
 */
/**
 * @file atomic.h
