 ...
 *
 * Description:
 *   This file defines the FreeRTOS event groups API, providing type
 *   definitions and control bit macros for synchronizing tasks using
 *   bit flags that can be set, cleared, and waited upon atomically. It
 *   includes architecture-independent abstractions for event group
 *   handles and event bits across different tick width configurations.
 */
