 ...
 *
 * Description:
 *   This is the main FreeRTOS header file that includes standard type
 *   definitions, validates essential configuration parameters from
 *   FreeRTOSConfig.h, sets default values for unconfigured options,
 *   and includes port-specific and basic FreeRTOS definitions to
 *   initialize the RTOS kernel for use in an embedded application.
 */
