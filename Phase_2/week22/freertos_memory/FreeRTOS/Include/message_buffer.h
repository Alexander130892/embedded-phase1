 ...
 *   which provide lightweight inter-task and interrupt-to-task
 *   communication by sending variable-length discrete messages (built
 *   on top of stream buffers). It enforces a single-writer,
 *   single-reader constraint and automatically prepends a size field
 *   to each message.
 */
/*
