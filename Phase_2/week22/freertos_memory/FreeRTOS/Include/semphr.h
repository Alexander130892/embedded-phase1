 ...
 *
 * Description:
 *   This file defines semaphore abstractions for FreeRTOS by wrapping
 *   the queue mechanism, providing macros and function declarations
 *   for creating and managing binary semaphores and other
 *   synchronization primitives. It serves as an interface layer that
 *   implements semaphores efficiently using FreeRTOS's underlying
