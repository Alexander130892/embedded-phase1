 ...
 *   support with FreeRTOS by defining macros to allocate, initialize,
 *   and manage TLS blocks for each thread. It handles
 *   platform-specific stack alignment and growth direction to properly
 *   position TLS data within thread stacks.
 */
