 ...
 *
 * Description:
 *   This file defines numeric identifiers for FreeRTOS kernel system
 *   calls that can be invoked from unprivileged code running under
 *   Memory Protection Unit (MPU) enforcement, enabling controlled
 *   access to protected kernel operations.
 */
