 ...
 *
 * Description:
 *   This file implements the scheduler and management infrastructure
 *   for FreeRTOS co-routines, maintaining priority-based ready queues,
 *   delayed co-routine lists, and handling the scheduling logic for
 *   lightweight cooperative multitasking primitives. It provides
 *   functionality to manage co-routine state transitions between
 *   ready, delayed, and pending states based on priorities and timing.
 */
#include "FreeRTOS.h"
#include "task.h"
#include "croutine.h"
