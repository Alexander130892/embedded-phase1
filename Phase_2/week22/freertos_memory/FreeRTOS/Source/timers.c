 ...
 *
 * Description:
 *   This file implements FreeRTOS software timer functionality,
 *   managing the creation, configuration, and execution of timers
 *   within the RTOS kernel. It defines the timer control structure and
 *   related APIs, with the entire implementation conditionally
 *   compiled only when `configUSE_TIMERS` is enabled in FreeRTOS
 *   configuration.
 */
/* Standard includes. */
#include <stdlib.h>
