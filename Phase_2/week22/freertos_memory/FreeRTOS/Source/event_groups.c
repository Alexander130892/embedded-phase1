 ...
 *
 * Description:
 *   This file implements FreeRTOS event groups functionality,
 *   providing synchronization primitives that allow tasks to wait for
 *   and set specific bits to coordinate execution. The implementation
 *   is conditionally compiled based on the `configUSE_EVENT_GROUPS`
 *   configuration flag and supports both static and dynamic memory
 *   allocation.
 */
/* Standard includes. */
#include <stdlib.h>
