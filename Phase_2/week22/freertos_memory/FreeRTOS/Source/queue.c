 ...
 *
 * Description:
 *   This file implements FreeRTOS queue management, providing data
 *   structures and core functionality for queues, semaphores, and
 *   mutexes within the FreeRTOS real-time operating system. It defines
 *   queue structures, lock states, and conditional macros for task
 *   synchronization across single and multi-core systems.
 */
#include <stdlib.h>
#include <string.h>
