 ...
 *
 * Description:
 *   This file is the core implementation of the FreeRTOS task
 *   scheduler, providing task creation, management, and scheduling
 *   functionality with support for both single-core and multi-core
 *   systems, as well as optional memory protection unit (MPU)
 *   features. It handles task state management, context switching, and
 *   includes utilities for task statistics and monitoring.
 */
/* Standard includes. */
#include <stdlib.h>
#include <string.h>
