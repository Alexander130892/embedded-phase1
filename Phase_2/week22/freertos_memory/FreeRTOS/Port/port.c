 ...
 *
 * Description:
 *   This file implements FreeRTOS kernel port functions for ARM
 *   Cortex-M4F processors, providing hardware abstraction for task
 *   scheduling, interrupt handling, and floating-point context
 *   management on ARM Cortex-M4 with FPU support.
 */
/*-----------------------------------------------------------
