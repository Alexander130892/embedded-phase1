 ...
 *
 * Description:
 *   This file implements FreeRTOS heap memory management (heap_4) with
 *   dynamic allocation and memory coalescing, automatically combining
 *   adjacent freed memory blocks to reduce fragmentation. It provides
 *   pvPortMalloc() and vPortFree() functions with optional heap
 *   corruption detection via canary values.
 */
/*
