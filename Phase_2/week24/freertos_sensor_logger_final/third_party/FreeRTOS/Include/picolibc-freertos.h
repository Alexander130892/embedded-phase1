 ...
 *   support with FreeRTOS by providing macros to allocate, initialize,
 *   and manage TLS blocks during thread creation and context
 *   switching. It handles architecture-specific stack alignment and
 *   supports multiple picolibc versions.
 */
