 ...
 *
 * Description:
 *   This file defines FreeRTOS semaphore abstractions, primarily using
 *   the underlying queue mechanism to implement binary semaphores and
 *   other synchronization primitives. It provides macros and function
 *   declarations for creating and managing semaphores used for task
