 ...
 *
 * Description:
 *   This header file defines the FreeRTOS message buffer API, which
 *   provides variable-length discrete message passing between tasks or
 *   interrupts built on top of stream buffers. Message buffers are
 *   lightweight and designed for single-writer, single-reader
 *   scenarios, automatically storing message length metadata alongside
 *   message data.
 */
/*
