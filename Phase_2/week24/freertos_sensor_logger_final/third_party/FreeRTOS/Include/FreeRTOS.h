 ...
 *
 * Description:
 *   FreeRTOS.h is the main header file that sets up the FreeRTOS
 *   kernel by including standard headers, loading application-specific
 *   configuration from FreeRTOSConfig.h, validating tick type
 *   settings, and including port-specific and core definitions. It
 *   serves as the central initialization point that configures the
 *   RTOS based on user-defined settings and enables various optional
 *   features like MPU support, access control, and platform-specific
 *   extensions.
 */
