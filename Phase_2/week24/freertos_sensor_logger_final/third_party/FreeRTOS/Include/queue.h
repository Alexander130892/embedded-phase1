 ...
 *
 * Description:
 *   This is a FreeRTOS header file that defines the interface for
 *   queue operations, including type definitions for queue handles and
 *   semaphores, along with internal constants and the documentation
 *   for queue creation and management functions. It requires
 *   FreeRTOS.h to be included first and provides the foundation for
 *   inter-task communication and synchronization primitives in
 *   embedded systems.
 */
#ifndef QUEUE_H
#define QUEUE_H
