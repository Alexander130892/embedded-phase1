 ...
 *
 * Description:
 *   This FreeRTOS header file defines fundamental project-level data
 *   types, macros, and constants including the task function
 *   prototype, time conversion macros between milliseconds and ticks,
 *   boolean/status return values, and POSIX-compatible errno
 *   definitions for FreeRTOS+ components.
 */
#ifndef PROJDEFS_H
#define PROJDEFS_H
