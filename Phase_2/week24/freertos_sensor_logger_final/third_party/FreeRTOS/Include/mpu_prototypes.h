 ...
 *   that map standard FreeRTOS API calls to privileged equivalents,
 *   allowing unprivileged application code to safely invoke kernel
 *   functions by wrapping them with privilege promotion and demotion
 *   logic.
 */
/*
