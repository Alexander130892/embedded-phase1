 ...
 *
 * Description:
 *   This file defines the FreeRTOS portable layer API by including
 *   port-specific macros and configurations from `portmacro.h`,
 *   establishing byte alignment settings, and declaring core
 *   platform-dependent functions like stack initialization that must
 *   be implemented for each hardware port.
 */
/*-----------------------------------------------------------
