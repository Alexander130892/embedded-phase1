 ...
 *
 * Description:
 *   This file provides FreeRTOS atomic operation primitives by
 *   disabling interrupts globally, with support for both nested and
 *   non-nested interrupt architectures. It defines critical section
 *   macros and implements atomic compare-and-swap operations for
 *   thread-safe access to shared memory in FreeRTOS tasks and
 *   compatible ISRs.
 */
/**
 * @file atomic.h
