 ...
 *
 * Description:
 *   This header file defines the FreeRTOS software timer API,
 *   providing types, macros, and function prototypes for creating and
 *   managing timers in FreeRTOS-based applications. It requires
 *   FreeRTOS.h to be included first and defines timer command IDs,
 *   callback function prototypes, and the TimerHandle_t type for
 *   referencing timer instances.
 */
#ifndef TIMERS_H
#define TIMERS_H
