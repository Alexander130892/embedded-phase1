 ...
 *
 * Description:
 *   This FreeRTOS header file defines the interface and control
 *   structures for event groups, which are synchronization primitives
 *   that allow tasks to wait for and signal specific bit patterns to
 *   coordinate execution. It establishes type definitions, control bit
 *   macros for different tick widths, and declares the event group API
