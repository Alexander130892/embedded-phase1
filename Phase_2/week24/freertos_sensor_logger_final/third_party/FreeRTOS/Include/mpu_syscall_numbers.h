 ...
 *
 * Description:
 *   This header file defines numeric identifiers for FreeRTOS system
 *   calls used in an MPU (Memory Protection Unit) configuration,
 *   enabling user-mode tasks to invoke kernel functions through a
 *   predefined syscall interface.
 */
