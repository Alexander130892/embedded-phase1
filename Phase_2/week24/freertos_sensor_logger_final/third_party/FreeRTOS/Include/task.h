 ...
 *
 * Description:
 *   This is a FreeRTOS header file that defines task management types,
 *   structures, and macros for creating and controlling tasks in
 *   embedded systems. It provides task handles, state enumerations,
 *   notification mechanisms, and MPU region configuration parameters
