 ...
 *
 * Description:
 *   This file implements FreeRTOS kernel port functionality for ARM
 *   Cortex-M4F microcontrollers, defining hardware-specific register
 *   mappings, interrupt priorities, and constants needed to manage the
 *   processor's core features including SysTick timer, nested vectored
 *   interrupt controller (NVIC), and floating-point unit (FPU).
 */
/*-----------------------------------------------------------
