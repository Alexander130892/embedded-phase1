 ...
 *
 * Description:
 *   This file implements a memory allocator for FreeRTOS that provides
 *   pvPortMalloc() and vPortFree() functions with automatic coalescing
 *   of adjacent free blocks to reduce heap fragmentation. It supports
 *   optional heap corruption detection via canary values and includes
 *   various overflow/underflow protection checks.
 */
/*
