 ...
 *
 * Description:
 *   This file implements the core task management functionality for
 *   FreeRTOS, including task creation, scheduling, state management,
 *   and synchronization primitives. It handles both single-core and
 *   multi-core configurations with optional MPU (Memory Protection
 *   Unit) support and preemptive/cooperative scheduling modes.
 */
/* Standard includes. */
#include <stdlib.h>
#include <string.h>
