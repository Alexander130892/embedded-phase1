 ...
 *   providing inter-task communication through FIFO buffers with task
 *   notification support. It is conditionally compiled based on
 *   FreeRTOS configuration settings and requires task notifications
 *   and task handle retrieval to be enabled.
 */
/* Standard includes. */
#include <string.h>
