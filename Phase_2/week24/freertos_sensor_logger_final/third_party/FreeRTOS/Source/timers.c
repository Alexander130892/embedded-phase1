 ...
 *   managing timer creation, configuration, and callback execution
 *   through a dedicated timer service task. It is conditionally
 *   compiled only when software timers are enabled via the
 *   `configUSE_TIMERS` configuration option.
 */
/* Standard includes. */
#include <stdlib.h>
