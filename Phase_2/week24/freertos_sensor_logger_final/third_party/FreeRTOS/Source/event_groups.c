 ...
 *
 * Description:
 *   This file implements FreeRTOS event groups functionality, which
 *   allows tasks to synchronize by waiting for and setting specific
 *   bit patterns within an event group object. The file provides APIs
 *   for creating, deleting, setting, and waiting on event bits, with
