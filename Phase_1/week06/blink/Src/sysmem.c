 ...
 *   heap growth from the end of static data up to a limit that
 *   preserves reserved stack space, returning an error if the heap
 *   would overflow into the stack area.
 */
/**
 ******************************************************************************
 * @file      sysmem.c
