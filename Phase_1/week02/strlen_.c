 ...
 *   strlen() function that calculates the length of a null-terminated
 *   string by iterating through each character until it reaches the
 *   null terminator. The implementation demonstrates the basic string
 *   length calculation algorithm and includes a test with the alphabet
 *   string to verify functionality.
 */
 //Libraries
#include <stdio.h>
#include <stdlib.h>
