 ...
 *   print, sort, and filter the list. It demonstrates various linked
 *   list operations including recursive creation and deallocation,
 *   bubble sort with custom comparison functions, and counting
