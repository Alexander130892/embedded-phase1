 ...
 *
 * Description:
 *   This program demonstrates the use of enums in C by creating a
 *   Month enumeration and displaying each month alongside its previous
 *   month, with special handling to wrap December back to January.
 */
//Libraries
#include <stdio.h>
#include <stdlib.h>
