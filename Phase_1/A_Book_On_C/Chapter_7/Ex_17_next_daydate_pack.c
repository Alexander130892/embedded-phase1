 ...
 *
 * Description:
 *   This C program implements a date packing system that stores day,
 *   month, and year values in a compact 16-bit unsigned short using
 *   bit manipulation, and provides functionality to calculate the next
 *   day from a packed date. The program demonstrates packing a
 *   user-input date into binary format, unpacking it back to verify
 *   the data, and then computing and displaying the following day.
 */
//Libraries
#include <stdio.h>
#include <stdlib.h>
