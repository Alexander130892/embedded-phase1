 ...
 *   median-of-three pivot selection strategy to sort an array of one
 *   million random integers. The program demonstrates the algorithm's
 *   performance by running quicksort multiple times on the same sorted
 *   array and printing sample elements from the beginning, middle, and
