 ...
 *   commands to corresponding handler functions, with a structure for
 *   associating command names with their execution functions and
 *   temporary implementations for LED, PWM, and status commands.
 */
#ifndef PARSER_H
#define PARSER_H
