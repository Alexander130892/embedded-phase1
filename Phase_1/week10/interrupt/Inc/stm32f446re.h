 ...
 *   interrupts, and USART communication. It provides low-level
 *   hardware abstraction by mapping peripheral base addresses and
 *   register offsets to enable direct register manipulation for
